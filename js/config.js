...
const NEXUS_CONFIG = {
  ...
  SESSION_KEY: 'nexus_sesion', PARAM_GET: 'accion', PARAM_POST_ACTION: 'accion', CACHE_TTL_MS: 60000,
  // Nombre del parametro GET usado para filtrar por empresa activa (regla
  // multiempresa). SUPUESTO A VERIFICAR contra tu Code.gs: si tu doGet lee
  // el filtro con otro nombre de parametro, cambialo solo aqui.
  ...
  POST_ACTIONS: { REGISTRAR_EMPRESA: 'registrar_empresa', REGISTRAR_USUARIO: 'registrar_usuario', REGISTRAR_EMPRESA_USUARIO: 'registrar_empresa_usuario', INICIAR_SESION: 'iniciar_sesion', REGISTRAR_EMPLEADO: 'registrar_empleado', REGISTRAR_NOVEDAD: 'registrar_novedad', REGISTRAR_VALIDACION: 'registrar_validacion', REGISTRAR_AUDITORIA: 'registrar_auditoria', PREGUNTAR_IA: 'preguntar_ia' },
