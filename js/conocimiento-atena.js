...
const ConocimientoAtena = (() => {
  const temas = [
    ...
    {
      claves: ['jornada laboral', 'horas de trabajo', 'jornada'],
      respuesta: 'La jornada laboral ordinaria diurna es de 8 horas diarias / 44 horas semanales como referencia general. Las horas que exceden ese limite suelen pagarse como horas extra con un recargo sobre el salario ordinario.',
    },
    {
      claves: ['horas extra', 'hora extra'],
      respuesta: 'Las horas extra son el tiempo trabajado fuera de la jornada ordinaria y se pagan con un recargo adicional sobre el valor de la hora normal. Regístralas en Novedades para que se incluyan en el calculo de la planilla del periodo.',
    },
    {
      claves: ['salario minimo'],
      respuesta: 'El salario minimo es el piso legal que debe pagarse por el trabajo en una jornada ordinaria; varia segun el sector economico y se actualiza por decreto. Verifica el monto vigente antes de registrar salarios nuevos.',
    },
    {
      claves: ['contrato indefinido', 'contrato determinado', 'tipo de contrato'],
      respuesta: 'Un contrato por tiempo indefinido no tiene fecha de finalizacion fija, mientras uno por tiempo determinado (o por obra) termina al cumplirse el plazo o la obra pactada. El tipo de contrato influye en como se calculan algunas prestaciones al finalizar la relacion laboral.',
    },
    {
      claves: ['despido', 'renuncia', 'terminacion de contrato', 'finiquito'],
      respuesta: 'Al terminar una relacion laboral (por renuncia o despido) suele liquidarse lo pendiente: salario proporcional, vacaciones y aguinaldo proporcionales, y en algunos casos indemnizacion. Cada caso depende del tipo de contrato y el motivo de la terminacion; consulta a tu asesor legal para el calculo exacto.',
    },
    {
      claves: ['dia de descanso', 'septimo dia', 'domingo'],
      respuesta: 'El dia de descanso semanal remunerado (comunmente el septimo dia) se paga aunque no se trabaje ese dia, siempre que el trabajador haya cumplido su semana laboral completa.',
    },
    {
      claves: ['planilla previsional', 'f-914', 'declaracion de planilla'],
      respuesta: 'La planilla previsional es el reporte periodico que resume los aportes de ISSS y AFP de todos los empleados de la empresa, y se usa para declarar y pagar esas cotizaciones ante las instituciones correspondientes.',
    },
  ];
